...
function GetStarted() {
  return (
    <section
      ...
      className="relative bg-black text-white flex items-center justify-center shadow-md z-20 h-[30vh]"
    >
      <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-6">
        ...
        <div className="md:w-1/2 flex flex-col flex-row items-center justify-center md:justify-end gap-4">
          ...
          <a
            href="#our-work"
            className="bg-white text-black hover:bg-gray-200 px-6 py-3 font-medium transition text-sm md:text-base"
          >
            View Our Works
          </a>
        </div>
